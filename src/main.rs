...
impl SelectedTab {
    ...
    //     // Welcome Paragraph
    //     let welcome_text = "Welcome to the Auto-Mp3 Tag Editor! This CLI tool allows you to:\n\
    //                         - Scrape metadata for your music collection.\n\
    //                         - Download music from Spotify and YouTube playlists.\n\
    //                         - Edit metadata for your songs.\n\
    //                         - Play your music directly from the CLI!\n\n\
    //                         This app is designed to make managing your music library a breeze.";

    //     // About Paragraph
    //     let about_text = "Hey there! Thanks for using the Automated Mp3 Tag Editor, by JRS Studios. \
    //                       This project was once a simple Python CLI tool, developed to complete a \
    //                       Software Engineering course. 3 years later, it has evolved into a full-stack \
    //                       Rust-based Desktop Application with an ML-powered backend, capable of handling \
    //                       offline music. We have grand plans, including developing a mobile app to \
    //                       support the music identified here. So thank you once again for using our app. \
    //                       Please feel free to contribute, and reach out to us for suggestions as well as \
    //                       bug reports. Keep Scraping!";

    //     // Usage Instructions
    //     let usage_text = "How to use this app:\n\
    //                       - Use the ◄ and ► arrow keys to navigate between tabs.\n\
    //                       - Press 'q' or 'Esc' to quit the application.\n\
    //                       - Press 'Space' to start/stop music playback.\n\
    //                       - Follow on-screen instructions for each tab to perform actions.";

    //     // Links
    //     let links_text = "For more information, visit:\n\
    //                       - GitHub: https://github.com/your-repo/auto-mp3-tag-editor\n\
    //                       - README: https://github.com/your-repo/auto-mp3-tag-editor#readme";

    //     // Combine all text into a single paragraph with styling
    //     let styled_text = vec![
    //         // ASCII Header (Blue and Bold)
    //         Line::from(ascii_header[0].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(ascii_header[1].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(ascii_header[2].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(ascii_header[3].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(ascii_header[4].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(ascii_header[5].to_string())
    //             .style(Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
    //         Line::from(""),
    //         Line::from(subheader)
    //             .style(Style::default().fg(Color::Yellow)),
    //         // Welcome Paragraph (Default Style)
    //         Line::from(welcome_text),
    //         // About Paragraph (Italic)
    //         Line::from(about_text)
    //             .style(Style::default().add_modifier(Modifier::ITALIC)),
    //         // Usage Instructions (Green)
    //         Line::from(usage_text)
    //             .style(Style::default().fg(Color::Green)),
    //         // Links (Cyan and Underlined)
    //         Line::from(links_text)
